...
.				\end{proof}
	...
	\section{Ejercicios}
		\begin{enumerate}
			...
			\begin{proof}
				No sé mano, pero creo que eso va a ir por cuenta de q usted puede truncar un cubrimiento e intersecar con A, lo que no sé es como garantizar la diferencia con el $\epsilon$
			\end{proof}
			\item 
